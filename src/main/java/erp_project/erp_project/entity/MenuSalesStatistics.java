...
@Entity
@Table(name = "menu_sales_statistics")
public class MenuSalesStatistics {
    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "menu_statistic_id")
    private Long menuStatisticId;
    ...
    // 기본 생성자
    public MenuSalesStatistics() {
        this.createdAt = LocalDateTime.now();
        this.updatedAt = LocalDateTime.now();
    }
    
    // Getters and Setters
    public Long getMenuStatisticId() { return menuStatisticId; }
    public void setMenuStatisticId(Long menuStatisticId) { this.menuStatisticId = menuStatisticId; }
